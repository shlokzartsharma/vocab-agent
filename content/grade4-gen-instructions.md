# Grade 4 Content Generation Instructions

Read /Users/suchitrasharma/vocab-agent/content/grade3/set12.json FIRST to see the exact JSON structure.

Generate a JSON file for each assigned set at: /Users/suchitrasharma/vocab-agent/content/grade4/setN.json
...
```json
{
  ...
  "setNumber": N,
  "words": ["word1", ..., "word12"],
  "sources": ["Common Core Grade 4", "Sadlier Vocabulary Workshop", "Wordly Wise 3000", "Flocabulary Grade 4", "CKLA Grade 4", "Tier 2 Academic"],
...
- Age-appropriate for Grade 4 (9-10 year olds)
...
- "meaning1": "Clear definition for a 4th grader. Example: A natural-sounding example sentence." (ALWAYS filled)
